...
def preprocessing(dataset_npz, pc_path, filename, index):
    ...
    x_b, x_s = patches_extraction(filename = pc_path, number_patches = 32, points_per_patch = 14900, small_points_per_patch = 8192)
...
if __name__ == "__main__":
    ...
    destination_npz_path = "data/WPC/distorted_npz_32"
